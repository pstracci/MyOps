# C:\Meus Projetos\MyOps\modules\siebel_pre\siebel_pre_ui.py
...
from modules.siebel_pre import siebel_pre_logic as db
...
class SiebelPreSessionManagerWidget(QWidget):
    def __init__(self):
        super().__init__()
    ...
    def on_sql_text_finished(self, sql_text): self.sql_text_edit.setText(format_sql(sql_text) if sql_text else "-- Nenhum SQL ativo ou recente para esta sessão --")
